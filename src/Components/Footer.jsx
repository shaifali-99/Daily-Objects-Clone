    ...
    <>
        ...
        <div style={{ padding: "30px" }} className="leftSocials">
          ...
          <div>
            <ul>
              ...
              <a href="">
                <li>Privacy & Policy Policy</li>
              </a>
            </ul>
          </div>
          <div>
            <ul>
              <li id="subHead">NETWORK</li>
              <a href="">
                <li>Contact Us</li>
              </a>
              <a href="">
      ...
      <div className="rightSocials">
        ...
        <div className="rightSocials_img">
          ...
          <a href="https://www.facebook.com/DailyObjects">
            <img
          ...
          <a href="https://www.youtube.com/channel/UC2gfsXOz3Nyn1vKyRpzlHhQ">
            <img
          ...
          <a href="https://twitter.com/Daily_Objects">
            <img
          ...
          <a href="https://www.pinterest.ca/dailyobjects/">
            <img
      ...
      <div style={{ padding: "44px" }} className="rightSocials_bottom">
        ...
        <div className="rightSocials_bottom_img">
          ...
          <a href="https://apps.apple.com/us/app/dailyobjects/id1141900369">
            <img
      ...
      <div className="bottomTabs4">
        ...
        <div className="bottomTabs4_list">
          ...
          <a href="">
            <p>Mobile & Laptop Stands</p>
          </a>
          <a href="">
            <p>Designer Notebooks & Planners</p>
          </a>
        </div>
      </div>
